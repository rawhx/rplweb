      ...
      <section id="about" class="about">
        <div class="container">
          ...
          <div class="c" style="display: flex;">
            ...
            <div class="row content" style="margin-left: 20px;">
                    <div class="col-lg-6">
                <a href="#guru" class="btn-learn-more">Pengajar</a>
                </div>
            </div>
          </div>
       ...
       <!-- ======= Counts Section ======= -->
        ...
        <div class="container">
            ...
            <div class="col-lg-3 col-6 text-center">
                <span data-purecounter-start="0" data-purecounter-end="3240" data-purecounter-duration="1" class="purecounter"></span>
                <p>Alumni</p>
            </div>
      ...
      <section id="guru" class="guru">
        <div class="container">
            <div class="section-title-client">
                <h2>Guru Produktif RPL </h2>
            </div>
            <div class="row" style="display: flex; justify-content: center; align-items: center;">
                <div class="col-md-3 col-sm-6">
                    <div class="profile-card">
                        <div class="profile-img">
                            <img src="assets/img/guru/bsepti.jpeg" alt="image"/>
                            <div class="over-layer">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae debitis dicta eaque ipsa iure, laborum quibusdam tempora ullam ut! Architecto aspernatur dignissimos fugiat pariatur sit! Ad amet beatae dolor eius, esse, eum eveniet fuga laborum minima nulla quam similique, sunt.</p>
                            </div>
                        </div>
                        <div class="profile-content">
                            <h3 class="title" style="font-size: 12pt; font-weight: bold;">Dian Retno Yuliati, A.Md.</h3>
                            <p>Kepala Bengkel RPL</p>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="profile-card">
                        <div class="profile-img">
                            <img src="assets/img/guru/pdanang.png" alt="image"/>
                            <div class="over-layer">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae debitis dicta eaque ipsa iure, laborum quibusdam tempora ullam ut! Architecto aspernatur dignissimos fugiat pariatur sit! Ad amet beatae dolor eius, esse, eum eveniet fuga laborum minima nulla quam similique, sunt.</p>
                            </div>
                        </div>
                        <div class="profile-content">
                            <h1 class="title" style="font-size: 12pt; font-weight: bold;">Dhanang Fitra R., S.Si, MT</h1>
                            <p>RPL (Pemrograman Web & Perangkat Bergerak)</p>
                            <ul class="social-link">
                                <li><a href=""><i class="bi bi-facebook"></i></a></li>
                                <li><a href=""><i class="bi bi-twitter"></i></a></li>
                                <li><a href=""><i class="bi bi-instagram"></i></a></li>
            ...
            <div class="row" style="display: flex; justify-content: center; margin-top: 20px;">
                <div class="col-md-3 col-sm-6">
                    <div class="profile-card">
                        <div class="profile-img">
                            <img src="assets/img/guru/btyas.jpeg" alt="image"/>
                            <div class="over-layer">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae debitis dicta eaque ipsa iure, laborum quibusdam tempora ullam ut! Architecto aspernatur dignissimos fugiat pariatur sit! Ad amet beatae dolor eius, esse, eum eveniet fuga laborum minima nulla quam similique, sunt.</p>
                            </div>
                        </div>
                        <div class="profile-content">
                            <h3 class="title" style="font-size: 12pt; font-weight: bold;">Anggreani Tyas Sari, S.Pd.</h3>
                            <p>Pemograman Berorientasi 27 Objek</p>
                            <ul class="social-link">
                                <li><a href=""><i class="bi bi-facebook"></i></a></li>
                                <li><a href=""><i class="bi bi-twitter"></i></a></li>
                                <li><a href=""><i class="bi bi-instagram"></i></a></li>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="profile-card">
                        <div class="profile-img">
                            <img src="assets/img/guru/pmahamudi.jpeg" alt="image"/>
                            <div class="over-layer">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae debitis dicta eaque ipsa iure, laborum quibusdam tempora ullam ut! Architecto aspernatur dignissimos fugiat pariatur sit! Ad amet beatae dolor eius, esse, eum eveniet fuga laborum minima nulla quam similique, sunt.</p>
                            </div>
                        </div>
                        <div class="profile-content">
                            <h3 class="title" style="font-size: 12pt; font-weight: bold;">Moh. Mahmudi, S.Kom, M.Pd.</h3>
                            <p>Pemrog. Berorientasi Objek, Basis Data</p>
                            <ul class="social-link">
                                <li><a href=""><i class="bi bi-facebook"></i></a></li>
                                <li><a href=""><i class="bi bi-twitter"></i></a></li>
                                <li><a href=""><i class="bi bi-instagram"></i></a></li>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="profile-card">
                        ...
                        <div class="profile-content">
                            <h3 class="title" style="font-size: 12pt; font-weight: bold;">Septi Retno Desi P., S.Pd.</h3>
                            <p>	P. Dasar, Sistem Komputer & Basis Data</p>
                            <ul class="social-link">
                                <li><a href=""><i class="bi bi-facebook"></i></a></li>
                                <li><a href=""><i class="bi bi-twitter"></i></a></li>
                                <li><a href=""><i class="bi bi-instagram"></i></a></li>
        ...
        <div class="container">
          ...
          <div class="row portfolio-container">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-ui">
              <img src="assets/img/portfolio/galih.png" class="img-fluid" alt="">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-ui">
              <img src="assets/img/portfolio/d-rent.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>D-Rent</h4>
                <p>UI/UX</p>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-Games">
              <img src="assets/img/portfolio/bird.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Grafika Bird</h4>
                <p>Games</p>
